...
import (
	...
	beaconConsensus "github.com/harbour-tech/go-ethereum-arbitrum/go-ethereum-arbitrum/consensus/beacon"
...
func TestNilWithdrawals(t *testing.T) {
	...
	for _, test := range tests {
		var (
			...
			shanghai       = genesis.Config.IsShanghai(genesis.Config.LondonBlock, test.blockParams.Timestamp, types.DeserializeHeaderExtraInformation(api.eth.BlockChain().CurrentHeader()).ArbOSFormatVersion)
		)
		if !shanghai {
