...
import (
	...
	"github.com/harbour-tech/go-ethereum-arbitrum/go-ethereum-arbitrum/core/state/pruner"
	"github.com/harbour-tech/go-ethereum-arbitrum/go-ethereum-arbitrum/core/txpool"
	"github.com/harbour-tech/go-ethereum-arbitrum/go-ethereum-arbitrum/core/txpool/blobpool"
	...
	"github.com/harbour-tech/go-ethereum-arbitrum/go-ethereum-arbitrum/internal/shutdowncheck"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	eth.blockchain, err = core.NewBlockChain(chainDb, cacheConfig, nil, config.Genesis, &overrides, eth.engine, vmConfig, eth.shouldPreserve, &config.TransactionHistory)
	if err != nil {
		return nil, err
	}
