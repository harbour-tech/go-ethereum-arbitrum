...
coverpkg="https://github.com/harbour-tech/go-ethereum-arbitrum/..."
...
repo=$GOPATH/src/https://github.com/harbour-tech/go-ethereum-arbitrum
compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/common/bitutil \
...
compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/eth/protocols/snap \
...
compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/tests/fuzzers/bn256 \
...
compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/tests/fuzzers/bls12381 \
...
compile_fuzzer https://github.com/harbour-tech/go-ethereum-arbitrum/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
